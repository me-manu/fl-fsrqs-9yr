...
\begin{figure*}
    ...
    \includegraphics[width = .45\linewidth]{lc_3C454p3_daily.pdf}
...
\begin{figure*}
    \centering
    \includegraphics[width = .45\linewidth]{lcfithop_3C273_orbit_all_maxiter2_fsys0p00_addcomp0_comb.pdf}
    \includegraphics[width = .45\linewidth]{lcfithop_PKSB1222+216_orbit_all_maxiter2_fsys0p00_addcomp0_comb.pdf}
    \caption{\label{fig:gti-3c273-pks1222}}
\end{figure*}

\begin{figure*}
    \centering
    \includegraphics[width = .45\linewidth]{lcfithop_3C279_orbit_all_maxiter2_fsys0p00_addcomp0_comb.pdf}
    \includegraphics[width = .45\linewidth]{lcfithop_PKS1510-089_orbit_all_maxiter2_fsys0p00_addcomp0_comb.pdf}
    \caption{\label{fig:gti-3c279-pks1510}}
\end{figure*}

\begin{figure*}
    \includegraphics[width = .45\linewidth]{lcfithop_CTA102_orbit_all_maxiter2_fsys0p00_addcomp0_comb.pdf}
    \includegraphics[width = .45\linewidth]{lcfithop_3C454p3_orbit_all_maxiter2_fsys0p00_addcomp0_comb.pdf}
...
We first investigate the global light curve properties such as the distribution of fluxes and the the power spectral densities (PSDs). 
Figure~\ref{fig:fluxpdf}
%%% Orbital light curve and fits
%%% result plots: asymmetry vs T90, peak flux vs T90, integrated flux vs T90? Distributions of rise and decay times?
%%% spectral variation of orbital light curves
%%% energy dependent light curves (selection)
%%% shortest variability times scales

%%% Full OVRO light curves %%%
\begin{figure}
    \centering
