...
We also provide the minimum values for the variability times, given by~\citep{1999ApJ...527..719Z}
\begin{equation}
t_\mathrm{var} = \frac{F_i + F_j}{2}\left|\frac{t_i - t_j}{F_i - F_j}\right|.
\end{equation}
...
\todo{Ly alpha dominates, estimate BLR photon density with Ly alpha, compare to the estimates in Dotson, see my notebook. In general, energy density the same but radius smaller.}
...
\end{figure*}
\begin{itemize}
    \item Resulting limits shown in Fig.~\ref{fig:blr_limits} for different BLR geometries and assumption on the intrinsic spectra. Limits also summarized in Tab.~\ref{tab:blrabs}.
    \item Fig.~\ref{fig:blr_limits} also shows results from distance from following consideration. From causality arguments, a lower limit on the size of the emitting region in the co-moving frame is provided through 
    \begin{equation}
    R'_\mathrm{blob} \leqslant \frac{ct_\mathrm{var}\delta}{1+z},  
    \end{equation}
    where $t_\mathrm{var}$ is the variability time scale and $\delta = \Gamma^{-1}(1 + \beta\cos\theta_\mathrm{obs})^{-1}$ is the Doppler boost factor with the bulk Lorentz factor of the flow, $\Gamma$ and $\beta = \sqrt{1 - \Gamma^{-2}}$ the associated velocity. Under the assumption of a conical jet with jet opening angle $\theta_\mathrm{j} \sim \Gamma^{-1}$ we obtain an upper limit on the distance to the black hole, $r \leqslant R'_\mathrm{blob}\Gamma$.
    ...
    The average values for $\delta$ and $\Gamma$ from \citet{2017ApJ...846...98J} are used and the total  uncertainty is obtained by summing the uncertainties on $\delta$, $\Gamma$, and the fit uncertainty of $t_\mathrm{var}$ in quadrature.
    \end{itemize}
\begin{figure}
    \centering
...
%        where $\delta_\mathrm{D}$ is the Doppler boost, $\epsilon_\mathrm^{obs}_s$
    ...
    \end{equation}
    \item Results are shown as an example for one flare of CTA102 in Fig.~\ref{fig:tcool}, discuss figure
    \item Now discuss energy dependent light curves, see my notebook (on source by source basis, see also below), then discuss data points in figure
\end{itemize}

\begin{figure}
    \centering
    \includegraphics[width = .9\linewidth]{figures/tcool_CTA102_t003.pdf}}
    \caption{Limits on the distance of the \gray emission zone to the central black hole.}
    \label{fig:tcool}
\end{figure}
...
\hline
55364.68 & 3.42 & 0.81 & 0.85 & 367.74 & 75.39 & 72.12 &  4.8 & 26.8 & $47.4\pm8.3$ \\
\hline
\multicolumn{10}{c}{3C279}\\
\hline
57188.07 & 1.87 & 0.17 & 0.23 & 307.31 & 56.03 & 46.20 & 2.0 & 19.0 & $0.5\pm0.9$ \\
58133.34 & 5.32 & 0.92 & 1.20 & 1627.73 & 92.56 & 92.54 & 4.7 & 19.0 & $8.2\pm6.3$\\
\hline
\multicolumn{10}{c}{PKS1510-089}\\
\hline
57114.16 & 1.42 & 0.29 & 0.38 & 620.96 & 66.54 & 61.03& 0.5 & 4.5 & $0.4\pm0.3$\\
57243.84 & 4.53 & 0.48 & 0.62 & 1022.22 & 75.93 & 73.27& 0.6 & 4.5 & $44.4\pm9.4$\\
\hline
\multicolumn{10}{c}{CTA102}\\
\hline
57749.10 & 4.99 & 1.82 & 1.10 & 723.31 & 73.80 & 48.67& 1.3 & 6.4 & $8.7\pm1.2$ \\
57757.55 & 4.66 & 0.57 & 0.34 & 224.78 & 39.19 & 34.27 & 0.6 & 6.4 & $24.6\pm2.3$\\
57861.71 & 2.42 & 0.42 & 0.26 & 169.07 & 34.73 & 33.13& 0.6 & 6.4 & $1.2\pm0.7$ \\
\hline
\multicolumn{10}{c}{3C454.3}\\
\hline
55516.55 & 8.93 & 0.58 & 0.25 & 290.36 & 41.19 & 32.77& 1.6 & 16.8 & $2.6\pm1.0$\\
\enddata
{
