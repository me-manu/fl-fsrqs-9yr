d\documentclass[twocolumn]{aastex62}
\usepackage{xspace}
...
\begin{figure*}
    ...
    \caption{Sub-GTI light curves}
    \label{fig:lc_minutes}
\end{figure*}

\begin{deluxetable*}{ccccccc}
\tablewidth{0pt}
\tablecaption{ \label{tab:blrabs}Results from sub-GTI light curves on minutes-scale variability.}
\tablehead{$t_0$ & $\Delta t$  & $\chi^2 / \mathrm{d.o.f.}$ & $p$-value & $p$-value& $\mathrm{min}(t_{var})$ & $\mathrm{min}(t_{double})$  \\ 
