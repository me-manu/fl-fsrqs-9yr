...
\tablehead{$t_0$ [MJD] & $\Delta t$ [days] & $r_\mathrm{limit}$ $[10^{17}\mathrm{cm}]$ & 
$r_\mathrm{limit}$ $[R_{\mathrm{Ly}\alpha}]$ & $r_\mathrm{limit}$ $[r_g]$ & $E_\mathrm{HEP}$ [GeV] & $E(\tau_{\gamma\gamma} = 1; r = r_\mathrm{limit})$ [GeV]
}
\startdata
\hline
\multicolumn{7}{c}{PKSB1222+216}\\
\hline
55364.68 & 3.42 & 0.81 & 0.85 & 367.74 & 75.39 & 72.12\\
\hline
\multicolumn{7}{c}{3C279}\\
\hline
57188.07 & 1.87 & 0.17 & 0.23 & 307.31 & 56.03 & 46.20\\
58133.34 & 5.32 & 0.92 & 1.20 & 1627.73 & 92.56 & 92.54\\
\hline
\multicolumn{7}{c}{PKS1510-089}\\
\hline
57114.16 & 1.42 & 0.29 & 0.38 & 620.96 & 66.54 & 61.03\\
57243.84 & 4.53 & 0.48 & 0.62 & 1022.22 & 75.93 & 73.27\\
\hline
\multicolumn{7}{c}{CTA102}\\
\hline
57749.10 & 4.99 & 1.82 & 1.10 & 723.31 & 73.80 & 48.67\\
57757.55 & 4.66 & 0.57 & 0.34 & 224.78 & 39.19 & 34.27\\
57861.71 & 2.42 & 0.42 & 0.26 & 169.07 & 34.73 & 33.13\\
\hline
\multicolumn{7}{c}{3C454.3}\\
\hline
55516.55 & 8.93 & 0.58 & 0.25 & 290.36 & 41.19 & 32.77\\
\enddata
{
\tablecomments{Comment.}
}
\end{deluxetable*}
...
\tablehead{$t_0$ [MJD] & $\Delta t$ [minutes] & $\chi^2 / \mathrm{d.o.f.}$ & $p$-value & $p$-value (post trial)& $\mathrm{min}(t_{var})$ [minutes] & $\mathrm{min}(t_{double})$ [minutes]}
\startdata
\hline
\multicolumn{7}{c}{3C279}\\
\hline
57189.07 & 30.72 & 1.93 & 0.051 (1.95$\sigma$) & 0.188 (1.32$\sigma$) & 5.65 & 3.82 \\
...
\multicolumn{7}{c}{PKS1510-089}\\
\hline
55854.07 & 50.80 & 2.01 & 0.091 (1.69$\sigma$) & 0.173 (1.36$\sigma$) & 7.87 & 5.18 \\
\hline
\multicolumn{7}{c}{CTA102}\\
\hline
57738.07 & 37.04 & 2.30 & 0.011 (2.55$\sigma$) & 0.032 (2.14$\sigma$) & 2.83 & 1.76 \\
57758.86 & 78.00 & 2.62 & 0.049 (1.97$\sigma$) & 0.049 (1.97$\sigma$) & 7.75 & 5.09 \\
\hline
\multicolumn{7}{c}{3C454.3}\\
\hline
55520.25 & 25.83 & 1.96 & 0.048 (1.98$\sigma$) & 0.216 (1.24$\sigma$) & 3.19 & 2.04 \\
\enddata
{
...
\begin{itemize}
    ...
    \item Used PSDs determined for radio and \gray data to calculate significance of LCCF
    ...
    \item determined peak of time lag $\tau_\mathrm{peak}$, and give its significance if $p$-value $<0.05$, if $\tau < 0$, it means that \gray light curve is leading the radio light curve
    \item Uncertainty of $\tau_\mathrm{peak}$ calculated with flux randomization and random subsample selection following \citet{1998PASP..110..660P} as suggested by \citet{2014MNRAS.445..437M}
...
\begin{figure*}
    \centering
    \includegraphics[width = .9\linewidth]{figures/lccf__nsim5000_fermi_EM13gaps-data_alma-band3_MM14gaps-none_lccf.pdf}
    \caption{Caption}
    \label{fig:lccf-ovro}
\end{figure*}
