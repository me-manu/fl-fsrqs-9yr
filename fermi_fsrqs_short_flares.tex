...
\begin{equation}
    d_{\gamma,r\nu} = \frac{\Gamma\delta_\mathrm{D}\beta c\tau_{\mathrm{peak},r\nu}}{1 + z}.
\end{equation}
...
MOJAVE blazar monitoring program along using very large baseline interferometry (VLBI) \citep{2012A&A...545A.113P}.
...
We show the LCCF between \gray and radio light curves in Fig. \todo{X} for the cases where we find a peak in the LCCF at a significance $p_\tau$-value $<0.05$. Time lags $\tau < 0$ mean that the \gray light curve leads the radio light curve. 
...
The peak and the uncertainties are marked by a 
