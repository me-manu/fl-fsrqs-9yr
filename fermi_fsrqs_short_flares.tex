...
\response{This is further supported by a cross-correlation analysis between $\gamma$-ray and radio/millimeter light curves, which is consistent with $\gamma$-ray production at the same location as the millimeter core for 3C273, CTA102, and 3C454.3.}
...
\keywords{galaxies: active --- galaxies: jets --- gamma rays: galaxies --- quasars: individual (PKSB1222+216, 3C273, 3C279, PKS1510-089, 3C454.3, CTA102) --- radiation mechanisms: non-thermal}
...
\response{
We freeze all spectral source parameters for sources detected with $\mathrm{TS} < 1$ or if the number of photons predicted to originate from the source after the initial optimazation is less than $10^{-3}\,$counts. 
}
The normalizations of the diffuse backgrounds are left free during the fit,\footnote{
\response{
This is necessary since the background templates have been derived with a different data selection compared to the present analysis.
} 
}
...
The
\response{
time ranges of identified flares
}
...
\response{
source parameters, $\vec{\pi}$, such as, e.g.,  flux normalization, power-law index, and spectral curvature (see also Appendix~\ref{sec:avg-spec} for the definition of the spectral models),
}
...
\hline
55364.68 & 3.42 & 1.33 & 1.40 & 609 & 75.39 & 69.69 & 8.2 & \response{2.3} & $47.4\pm8.3$\\
\hline
...
\hline
57737.41 & 1.67 & 1.41 & 0.86 & 562 & 36.25 & 21.23 & 1.0 & \response{1.5} & $0.3\pm0.5$\\
57749.10 & 4.99 & 3.20 & 1.95 & 1275 & 73.80 & 37.94& 2.8 & \response{1.5} & $8.7\pm1.2$ \\
57757.55 & 4.66 & 2.76 & 1.67 & 1096 & 39.19 & 32.38& 2.2 & \response{1.5} & $24.6\pm2.3$ \\
57861.71 & 2.42 & 1.95 & 1.18 & 776 & 34.73 & 24.94& 1.4 & \response{1.5} & $1.2\pm0.7$ \\
\hline
