...
For the GTIs where the constant fit results in a pre-trial $p$-value of less than 0.1, we report the pre- and post-trial fit probabilities in Tab.~\ref{tab:minute}.
